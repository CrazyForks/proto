...
- Fixed an issue where stale cached plugins would not be re-acquired.

## 0.57.4

#### 🐞 Fixes

- Fixed a Windows file locking race condition.
...
- Fixed a regression where we would make unnecessary network calls when downloading plugins and the cache exists.
